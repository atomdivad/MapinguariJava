...
public class FrameAlteraConsulta extends JFrame {
    ...
    public FrameAlteraConsulta(ActionListener listener) {
    ...
    public void setTextDataChooser(String s) {
        TextDataChooser.setText(s);
    }
    ...
    public void setcTextoHora(String s) {
        cTextoHora.setText(s);
    }
    ...
    public void setCpfMedico(String cpf) {
        medico = fd.buscaMedico(cpf);
    }

    public void setCpfSecretaria(String cpf) {
        secretaria = fd.buscaSecretaria(cpf);
    }
