...
public class FrameEditarPaciente extends JFrame {
    ...
    public FrameEditarPaciente(ActionListener listener) {
...
//        cTextoLote.addActionListener(listener);
    ...
    public void setcTextoDataNascimento(String cTextoDataNascimento) {
        this.TextDataChooser.setText(cTextoDataNascimento);
    }
    ...
    public void setcTextoRg(int rg) {
        this.cTextoRg.setText(Integer.toString(rg));
    }
