...
public class painelTabelaPacientesSessaoMedico extends JPanel {
...
//        private consultaDAO cd = new consultaDAO();
    ...
    public painelTabelaPacientesSessaoMedico(ActionListener listener) {
        botaoSelecionar = new JButton();
        
        botaoSelecionar.setText("Histórico");
...
//        }
    ...
    public class tabelaModelo extends DefaultTableModel implements TableModelListener {
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            ...
            Object s = null;
            if (dados != null && dados.size() > 0) {
                pac = (paciente) dados.get(rowIndex);
                switch (columnIndex) {
                    case 0:
                        s = pac.getNome();
                        break;
    ...
    public JTable getTableDados(){
        ...
        public ArrayList<paciente> pegaLista(){
        return dados;
    }
