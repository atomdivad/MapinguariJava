...
public class painelTabelaConsultas extends JPanel {
    ...
    public painelTabelaConsultas(ActionListener listener) {
        botaoEditar = new JButton();
        botaoExcluir = new JButton();
        botaoEditar.setText("Editar");
        botaoExcluir.setText("Excluir");
        
        tableDados = new JTable(new painelTabelaConsultas.tabelaModelo());
...
//        }
    ...
    public class tabelaModelo extends DefaultTableModel implements TableModelListener {
        ...
        public tabelaModelo() {
            ...
            dados = cd.buscaConsultasSecretariaFrame();
